...
**File**: `frontend/lib/core/services/cryptography_service.dart`  
**Lines**: 155  
...
**File**: `frontend/lib/features/chat/application/chat_controller.dart`  
**Lines**: 222  
...
**File to create**: `frontend/scripts/run_tests.sh`
...
```bash
chmod +x frontend/scripts/run_tests.sh
...
**File to create**: `backend/scripts/run_p5_tests.sh`
...
```bash
chmod +x backend/scripts/run_p5_tests.sh
...
**File to create**: `scripts/run_all_p5_tests.sh`
