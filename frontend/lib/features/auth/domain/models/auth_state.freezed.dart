...
mixin _$AuthState {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, user, errorMessage, isLoading);
...
extension AuthStatePatterns on AuthState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(AuthStatus status, String? user, String? errorMessage,
            bool isLoading)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _AuthState() when $default != null:
        return $default(
            _that.status, _that.user, _that.errorMessage, _that.isLoading);
      case _:
        return orElse();
    }
  }
